...
import { generateDaList } from "@/utils/dadidudedo";
                ...
                if (nextBuffer === expected) {
                    ...
                    if (nextIndex >= chars.length) {
                        ...
                        if (mistakes === 0) {
                            ...
                            setTimeout(() => {
                                router.push(`/result?mistakes=0&time=${endTime - (startTime || 0)}&from=typing/dadidudedo`);
                            }, 2000);
                        } else {
                            if (bgmRef.current) {
                            ...
                            router.push(`/result?mistakes=${mistakes}&time=${endTime - (startTime || 0)}&from=typing/dadidudedo`);
                        }
                    } else {
                        setIndex(nextIndex);
