...
import { generateLaList } from "@/utils/lalilulelo";
                ...
                if (nextBuffer === expected) {
                    ...
                    if (nextIndex >= chars.length) {
                        ...
                        if (mistakes === 0) {
                            ...
                            setTimeout(() => {
                                router.push(`/result?mistakes=0&time=${endTime - (startTime || 0)}&from=typing/lalilulelo`);
                            }, 2000);
                        } else {
                            if (bgmRef.current) {
                            ...
                            router.push(`/result?mistakes=${mistakes}&time=${endTime - (startTime || 0)}&from=typing/lalilulelo`);
                        }
                    } else {
                        setIndex(nextIndex);
